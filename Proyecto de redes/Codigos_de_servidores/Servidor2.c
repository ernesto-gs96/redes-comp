...
//  Pruebas 2
//
//  Created by Ricardo Aandres Jimenez Rodriguez on 10/13/19.
...
int main(int argc, char const *argv[])
{
                       ...
                       (socklen_t*)&addrlen))<0)
    {
      ...
      while(1)
      {
          ...
          char direccion[2048]={"/Users/Richi/Documents/Documents/Documentos/Redes/Servidores_fragmentados/Servidor2/"};
          ...
          else if(opciones==2)
          {
              ...
              salir_archivo=fread(cad_contenido_archivo, 1, 1024, archivo);
              send(new_socket, &entero_a_enviar, sizeof(int), 0);
              recv(new_socket, &listo,sizeof(int),0);
              send(new_socket, cad_contenido_archivo, 1024, 0 );
              recv(new_socket, &listo,sizeof(int),0);
              while(1){
